...
function Home() {
  return (
    <div className="relative mx-auto max-w-6xl px-4 pb-12">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(251,191,36,0.15),transparent_35%),radial-gradient(circle_at_80%_0%,rgba(14,165,233,0.22),transparent_30%)]" />

      <div className="relative grid gap-8 lg:grid-cols-[2fr,1fr]">
        <header className="rounded-3xl border border-white/10 bg-white/5 px-6 py-8 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.8)] backdrop-blur">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
            <div className="relative h-32 w-32 shrink-0 overflow-hidden rounded-3xl border border-white/15 shadow-xl shadow-amber-500/20">
              <img src="/rr1.jpeg" alt="Actor Ramana Reddy portrait" className="h-full w-full object-cover" />
            </div>
            <div className="flex-1">
              ...
              <p className="mt-4 max-w-3xl text-base text-slate-200/90">
        ...
        <aside className="space-y-4 rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-white/5 p-6 backdrop-blur">
      ...
      <div className="mt-10 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-100">
          ...
          working alongside veteran casts and directors. Open to film, OTT, and television projects with a preference for
